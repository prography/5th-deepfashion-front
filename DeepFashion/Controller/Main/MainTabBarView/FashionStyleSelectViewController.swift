...
class FashionStyleSelectViewController: UIViewController {
...
extension FashionStyleSelectViewController: UICollectionViewDelegateFlowLayout {
    func collectionView(_: UICollectionView, layout _: UICollectionViewLayout, sizeForItemAt _: IndexPath) -> CGSize {
        guard let flowLayout: UICollectionViewFlowLayout = styleCollectionView.collectionViewLayout as? UICollectionViewFlowLayout else { return CGSize.zero }
...
extension FashionStyleSelectViewController: UICollectionViewDelegate {
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        print("\(indexPath.item)th Item Cell Pressed!!")
    }
}

extension FashionStyleSelectViewController: UICollectionViewDataSource {
